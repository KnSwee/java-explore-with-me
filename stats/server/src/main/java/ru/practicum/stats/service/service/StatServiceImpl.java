...
public class StatServiceImpl implements StatService {
    ...
    public List<ViewStatsDto> getViewStats(String start, String end, List<String> uris, boolean unique) {
        if ((start == null || start.isBlank()) && end != null || (end == null || end.isBlank()) && start != null) {
            throw new BadRequestException("Если указан один из параметров start/end, должен быть указан и второй");
        }
