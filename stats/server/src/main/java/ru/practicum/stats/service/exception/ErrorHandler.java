...
public class ErrorHandler {
    ...
    @ExceptionHandler(ru.practicum.stats.service.exception.BadRequestException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ErrorResponse handleValidationException(final BadRequestException e) {
        log.info("bad request 400 - {}", e.getMessage());
    ...
    public ErrorResponse handleThrowable(final Throwable e) {
        log.info("internal server error 500 - {}", e.getMessage());
